...
@Immutable public final class IncomingPhoneNumber {
  ...
  {
      return "[ IncomingPhoneNumber [ phoneNumber: "+phoneNumber+ ", voiceUrl:"+voiceUrl+
              ", sid:"+sid+", account_sid:"+accountSid+", voiceFallbackMethod:"+voiceFallbackMethod
              +", uri:"+uri+", dateUpdated:"+dateUpdated+" voiceApplicationSid:"+voiceApplicationSid+"] ]";
  }
