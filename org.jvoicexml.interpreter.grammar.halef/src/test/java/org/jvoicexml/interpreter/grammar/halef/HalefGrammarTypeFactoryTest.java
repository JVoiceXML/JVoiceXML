...
/**
 * Test cases for {@link HalefGrammarTypeFactory}.
 * 
 * @author Dirk Schnelle-Walka
 * @since 0.7.9
 */
public class HalefGrammarTypeFactoryTest {

    /**
     * Test method for
     * {@link org.jvoicexml.interpreter.grammar.halef.HalefGrammarTypeFactory#getGrammarType(java.lang.String)}.
     */
    @Test
    public void testGetGrammarType() {
        final GrammarTypeFactory factory = new HalefGrammarTypeFactory();
        final GrammarType type = factory
                .getGrammarType(HalefGrammarType.GRAMMAR_TYPE.toString());
        Assert.assertTrue(HalefGrammarType.GRAMMAR_TYPE.match(type.getType()));
    }
