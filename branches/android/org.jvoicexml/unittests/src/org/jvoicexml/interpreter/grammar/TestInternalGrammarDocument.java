/*
 * File:    $HeadURL: https://svn.code.sf.net/p/jvoicexml/code/trunk/org.jvoicexml/unittests/src/org/jvoicexml/interpreter/grammar/TestInternalGrammarDocument.java $
...
public class TestInternalGrammarDocument {
    ...
    public void testGetDocument() throws Exception {
        final VoiceXmlDocument vxmlDocument = new VoiceXmlDocument();
        final Vxml vxml = vxmlDocument.getVxml();
