/*
 * File:    $RCSfile: ConnectionDisconnectHangupEvent.java,v $
...
public class ConnectionDisconnectHangupEvent
    ...
    private static final long serialVersionUID = 7711323127850355718L;
     ...
     * @see #getEventType()
     */
    public ConnectionDisconnectHangupEvent() {
        super();
    }
     ...
     * @see #getEventType()
     */
    public ConnectionDisconnectHangupEvent(final String message) {
        super(message);
    }
     ...
     * @see #getEventType()
     */
    public ConnectionDisconnectHangupEvent(final Throwable cause) {
        super(cause);
    }
