  ...
  <xsl:template match="java[@classname='org.jvoicexml.startup.Startup']">
    <xsl:copy>
      ...
      <xsl:apply-templates select="@*" />
        <xsl:comment>Added path for org.jvoicexml.interpreter.grammar.luis grammar support</xsl:comment>
        <classpath>
            <pathelement location="dist/org.jvoicexml.interpreter.grammar.luis.jar"/>
        </classpath>
