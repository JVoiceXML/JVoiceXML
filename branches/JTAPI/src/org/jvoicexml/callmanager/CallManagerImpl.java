...
public class CallManagerImpl implements CallManager {
    ...
    //log
    protected static Console console = Console.getConsole(CallManagerImpl.class);
    ...
    public static void main(String[] args) {
        ...
        CallManagerImpl _callManager = null;
        _callManager = new CallManagerImpl();
        _callManager.start();
        console.logExit();
    }
    ...
    public void start() {
        ...
        try {
            ...
            for (int i = 0; i < address.length; i++) {
                ...
                CallControlImpl callControl = new CallControlImpl(ms);
