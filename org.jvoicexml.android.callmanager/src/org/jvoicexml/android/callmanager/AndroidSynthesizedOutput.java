...
public class AndroidSynthesizedOutput implements SynthesizedOutput,
	...
	public void open() throws NoresourceError {
		//Este c—digo de comprobaci—n debe ir en una actividad
//		Intent checkIntent = new Intent();
//		checkIntent.setAction(TextToSpeech.Engine.ACTION_CHECK_TTS_DATA);
//		startActivityForResult(checkIntent, MY_DATA_CHECK_CODE);
		
		mTts =new TextToSpeech(this.callManagerContext, this);
		...
		Log.e("AndroidSynthesizedOutput","sali— de la inicializaci—n del TTS Engine");
	...
	public boolean isBusy() {
		return processingSpeakable || mTts.isSpeaking();
	}
...
//        if (LOGGER.isDebugEnabled()) {
//            LOGGER.debug("processing next speakable: " + speakable.getSpeakableText());
//        }
...
//           int id = mTts.speak(text, this);
        ...
        params.put(TextToSpeech.Engine.KEY_PARAM_UTTERANCE_ID,"stringId");
        	...
        	Log.e("AndroidSynthesizedOutput","Termin— de hablar y sali— del wait()");
...
//    }
	...
	//this code should go in the demo activity
...
//    }
	...
	public void onInit(int status) {
		synchronized (this) {
			Log.e("AndroidSynthesizedOutput","TTS Engine Initialized");
