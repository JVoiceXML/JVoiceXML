...
/**
 * The <code>&lt;example&gt;</code> element includes an example sentence that
 * illustrates an occurrence of this lexeme. Because the examples are explicitly
 * marked, automated tools can be used for regression testing and for
