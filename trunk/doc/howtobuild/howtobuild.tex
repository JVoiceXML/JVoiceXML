...
part and for providing some screen shots.
...
\begin{lstlisting}
svn co \
https://jvoicexml.svn.sourceforge.net/svnroot/jvoicexml \
jvoicexml
\end{lstlisting}
...
main development \emph{trunk} you will have to append \texttt{/trunk} to
the HTTPS URL:
...
The JSAPI 2.0 specification is undergoing changes.
...
from conversay's web page this is optional. The build file will
check for existence of the jar file and omit the corespondent compilation
...
\begin{itemize}
\item enabled configuration of the logger
\end{itemize}
...
Note that the used library is a modified version. Modifications include
\begin{itemize}
\item use of a logger instead of \texttt{System.out.println}
\item smaller bug fixes
\end{itemize}
...
\item jvxml-jsapi2.0.jar This jar contains a core implementation platform
based on JSAPI 2.0.
\item jvxml-jsapi2.0-impl.jar This jar contains a demo implementation
platform for JSAPI 2.0 using sphinx and FreeTTS.
