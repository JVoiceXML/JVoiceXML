...
/**
 * The default implementation of a script that listens for three requests to
 ...
 * @since 0.7.6
 */
public final class Press1ThreeTimesScript implements Script {
    ...
    public void perform(final Call call) {
        ...
        call.enter("1");
        call.hears("Press '1' again.", Script.DEFAULT_TIMEOUT);
        call.enter("1");
        call.hears("Press '1' one more time.", Script.DEFAULT_TIMEOUT);
        call.enter("1");
