...
public interface IVoiceXMLBrowserConstants {
	...
	/**
	 * Event type defining a log message contained in a VoiceXML <log> tag was received from the
	...
	public static final int EVENT_LOG_MESSAGE = 3;
        ...
        /**
         * Event type defining a dialog message from either the current user or the system.
     *
