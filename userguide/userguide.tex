...
given in section~\ref{sec:configuration-files}.
...
\section{JSAPI 1.0 with Sphinx and FreeTTS}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.jsapi10/etc/jsapi10-implementation-dist.xml}
