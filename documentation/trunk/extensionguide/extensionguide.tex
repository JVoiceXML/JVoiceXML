...
The remote client object is passed to the external resources, once they are
obtained from the pool, see figure~\ref{fig:get-external-resource-from-pool}
using the custom identification string as the key. By calling the
