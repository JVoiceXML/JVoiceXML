...
Therefore create a VoiceXML document with the follwoing contents
...
The classid tells us which class shoud be taken and which method to call. The
...
\url{http://localhost:8080/objectdemo}.
...
able to instantiate by JVoiceXML
