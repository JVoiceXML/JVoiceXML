...
/**
 * Test cases for {@link RegexGrammarTypeFactory}.
 * @author Dirk Schnelle-Walka
 * @since 0.7.9
 */
public class RegexGrammarTypeFactoryTest {
    /**
     * Test method for
     * {@link org.jvoicexml.interpreter.grammar.regex.RegexGrammarTypeFactory#getGrammarType(java.lang.String)}.
     */
    @Test
    public void testGetGrammarType() {
        final GrammarTypeFactory factory = new RegexGrammarTypeFactory();
        final GrammarType type = factory
                .getGrammarType(RegexGrammarType.GRAMMAR_TYPE.toString());
        Assert.assertTrue(RegexGrammarType.GRAMMAR_TYPE.match(type.getType()));
    }
