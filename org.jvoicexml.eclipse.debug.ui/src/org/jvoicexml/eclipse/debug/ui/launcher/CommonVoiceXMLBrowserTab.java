...
public class CommonVoiceXMLBrowserTab extends AbstractLaunchConfigurationTab {
    ...
    private void refreshActiveConfigurationPane() {
        ...
        try {
            Object o = browserElements[idx]
                    .createExecutableExtension("configurationUIClass"); //$NON-NLS-1$
            ...
            currentBrowserUI.drawConfigurationUI(customPane,
                    new BrowserConfigurationUIListener() {
    ...
    public void initializeFrom(ILaunchConfiguration configuration) {
        try {
            ...
            String browser = configuration.getAttribute(
                    IVoiceXMLBrowserConstants.LAUNCH_BROWSER_ID, ""); //$NON-NLS-1$
