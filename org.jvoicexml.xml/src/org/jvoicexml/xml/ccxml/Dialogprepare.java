/*
 * File:    $HeadURL: https://svn.code.sf.net/p/jvoicexml/code/trunk/org.jvoicexml.xml/src/org/jvoicexml/xml/ccxml/Dialogprepare.java $
...
/**
 * <code>&lt;dialogprepare&gt;</code> is used to get an appropriate dialog
 * handler ready to process, it is used as the precursor to a
 * <code>&lt;dialogstart&gt;</code> request. The element includes a URI
 ...
 * <code>&lt;dialogprepare&gt;</code> element is entirely optional,
 * applications may choose to simply use <code>&lt;dialogstart&gt;</code>
...
public final class Dialogprepare
     ...
     */
    private Dialogprepare(final Node n,
    ...
    public XmlNode newInstance(final Node n,
            final XmlNodeFactory<? extends XmlNode> factory) {
        return new Dialogprepare(n, factory);
    }
