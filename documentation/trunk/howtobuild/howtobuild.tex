...
line. In the latter case remove the \lstinline{.svn} folder if you checkout
...
in your copy of \texttt{platforms.xml} in the folder \texttt{personal-props}.
...
\subsection{Project \lstinline{org.jvoicexml.config}}
...
\lstinline{jndi.properties} to the configured port. Make sure to also adapt
the \lstinline{jndi.properties} in the demos or your application.
...
\subsection{Project \lstinline{org.jvoicexml.implementation.marc}}
...
In addition we use a custom \lstinline[language=Java]{@todo} JAVADOC tag or a \texttt{TODO} tag to
...
Developers are requested to use the \lstinline[language=Java]{@inheritDoc}
JAVADOC tag in favor of a \lstinline[language=Java]{@see} reference for inherited documentation.
Pros of the \lstinline[language=Java]{@inheritDoc} tag, taken 
...
\hline
1.9.4 & Added org.jvoicexml.config. Added more eclipse specific hints to setup
the IDE & Dirk Schnelle-Walka & 01/26/2011
\\
\hline
1.9.5 & Included MARC. & Dirk Schnelle-Walka & 09/01/2011
\\
\hline
\end{tabular}
