...
public final class Parallel
    ...
    /** Name of the tag. */
    public static final String TAG_NAME = "parallel";
    ...
    /**
     * Construct a new parellel object.
     * @param node The encapsulated node.
     */
    Parallel(final Node node) {
        super(node);
    }
