/*
 * File:    $HeadURL: https://jvoicexml.svn.sourceforge.net/svnroot/jvoicexml/core/trunk/org.jvoicexml.xml/src/org/jvoicexml/xml/vxml/Noinput.java $
 ...
 * <p>
 * The <code>&lt;noinput&gt;</code> element abbreviates
 * <code>&lt;catch event="noinput"&gt;</code> :
 * </p>
 * <p>
 * <code>
...
public final class Noinput
    ...
    /** Name of the tag. */
    public static final String TAG_NAME = "noinput";
    ...
    /**
     * Construct a new noinput object.
     *
     * @param node
     *        The encapsulated node.
     */
    Noinput(final Node node) {
        super(node);
    }
