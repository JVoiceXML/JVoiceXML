/*
 * File:    $RCSfile: MaxspeechtimeoutEvent.java,v $
 * Version: $Revision$
 * Date:    $Date$
 * Author:  $Author$
 * State:   $State: Exp $
...
public class MaxspeechtimeoutEvent
    ...
    private static final long serialVersionUID = -3295069233471221647L;
     ...
     * @see #getEventType()
     */
    public MaxspeechtimeoutEvent(final String message) {
        super(message);
    }
     ...
     * @see #getEventType()
     */
    public MaxspeechtimeoutEvent(final Throwable cause) {
        super(cause);
    }
     ...
     *        The cause.
     */
    public MaxspeechtimeoutEvent(final String message, final Throwable cause) {
        super(message, cause);
    }
