...
/**
 * An MMI resume request.
 * @author Dirk Schnelle-Walka
 * @since 0.7.6
 */
public final class StartResponse extends LifeCycleResponse
    implements Serializable {
    /** The serial version UID. */
    private static final long serialVersionUID = 3159516092437998460L;
     ...
     * @since 0.7.9
     */
    public StartResponse(final String requestId, final String source,
