 ...
 * scenario:
 * <ol>
 * <li>Create an instance of Sniffer with your wished VoiceXML resource.</li>
 * <li>Initialize a new conversation with your Sniffer object.</li>
...
implements org.jvoicexml.client.text.TextListener {
     ...
     */
    public Conversation init(final Sniffer call) {
        this.call = call;
