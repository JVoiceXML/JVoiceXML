...
public final class Datamodel
    ...
    /**
     * URL of the schema for this datamodel.
     */
    ...
    /**
     * Construct a new datamodel object.
     * @param node The encapsulated node.
     */
    Datamodel(final Node node) {
        super(node);
    }
     ...
     */
    private Datamodel(final Node n,
    ...
    public XmlNode newInstance(final Node n,
            final XmlNodeFactory<? extends XmlNode> factory) {
        return new Datamodel(n, factory);
    }
     ...
     *
     * @param schema Value of the schema attribute.
     * @see #ATTRIBUTE_SCHEMA
     */
    public void setSchema(final String schema) {
        setAttribute(ATTRIBUTE_SCHEMA, schema);
    }
