 ...
 * @since 0.7.7
 */
public final class UDPConnection extends Observable implements Runnable {
    /**
     ...
     *             the address cannot resolved
     * @throws SocketException
     *             some errors with the socket occurs
     */
    ...
    public void send(final String bmlString) {
        try {
            ...
            final DatagramPacket packet = new DatagramPacket(stringBytes,
                    stringBytes.length);
            socket.send(packet);
