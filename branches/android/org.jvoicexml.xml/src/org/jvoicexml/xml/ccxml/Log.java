/*
 * File:    $HeadURL: https://svn.code.sf.net/p/jvoicexml/code/trunk/org.jvoicexml.xml/src/org/jvoicexml/xml/ccxml/Log.java $
...
/**
 * A list of one or more whitespace separated CCXML unqualified variable names
 * to be returned. These variable names and their associated values will be set
...
public final class Log
    ...
    /**
     * An ECMAScript expression which returns a character string which may be
     * used, for example, to indicate the purpose of the log.
     */
