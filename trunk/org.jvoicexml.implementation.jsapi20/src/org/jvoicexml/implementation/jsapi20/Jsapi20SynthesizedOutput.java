 ...
 * </p>
 */
public final class Jsapi20SynthesizedOutput implements SynthesizedOutput,
  ...
  private void fireOutputStarted(final SpeakableText speakable) {
    final SynthesizedOutputEvent event =
        new SynthesizedOutputEvent(this,
                                   SynthesizedOutputEvent.OUTPUT_STARTED,
                                   speakable);
  ...
  private void fireOutputEnded(final SpeakableText speakable) {
    final SynthesizedOutputEvent event =
        new SynthesizedOutputEvent(this,
                                   SynthesizedOutputEvent.OUTPUT_ENDED,
                                   speakable);
  ...
  private void fireOutputUpdate(final SynthesisResult synthesisResult) {
    final SynthesizedOutputEvent event =
        new SynthesizedOutputEvent(this,
                                   SynthesizedOutputEvent.OUTPUT_UPDATE,
                                   synthesisResult);
   ...
   * @throws PropertyVetoException Error in assigning the voice.
   */
    ...
    if (type == SpeakableEvent.SPEAKABLE_STARTED) {
      ...
      if ( (phoneInfos != null) && (phoneInfos.length > 0)) {
        ...
        for (int i = 0; i < phoneInfos.length; i++) {
          final SpeakablePhoneInfo spi = new SpeakablePhoneInfo(phoneInfos[i].
              getPhoneme(), phoneInfos[i].getDuration());
      ...
      final Jsapi20SynthesisResult jsapi20SpeakableResult = new
          Jsapi20SynthesisResult(speakableText, speakablePhones);
