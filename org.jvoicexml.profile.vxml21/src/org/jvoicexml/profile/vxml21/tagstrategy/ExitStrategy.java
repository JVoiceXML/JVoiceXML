/*
 * File:    $HeadURL: https://svn.code.sf.net/p/jvoicexml/code/trunk/org.jvoicexml/src/org/jvoicexml/interpreter/tagstrategy/ExitStrategy.java $
...
final class ExitStrategy extends AbstractTagStrategy {
    ...
    private static final Logger LOGGER = Logger.getLogger(ExitStrategy.class);
