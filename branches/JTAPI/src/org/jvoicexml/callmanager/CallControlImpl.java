 ...
 * @version 1.0
 */
public class CallControlImpl implements CallControl, ConnectionListener,
        CallObserver,
        PlayerListener {

//log
    protected static Console console = Console.getConsole(CallControlImpl.class);
     ...
     */
    public CallControlImpl(GenericMediaService mediaService) {
        console.logEntry();
