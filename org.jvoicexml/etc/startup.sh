...
LOCAL_CLASSPATH="${LOCAL_CLASSPATH}:${JVOICEXML_LIB}/jetty-http-9.2.2.v20140723.jar.jar"
LOCAL_CLASSPATH="${LOCAL_CLASSPATH}:${JVOICEXML_LIB}/jetty-io-9.2.2.v20140723.jar.jar"
LOCAL_CLASSPATH="${LOCAL_CLASSPATH}:${JVOICEXML_LIB}/jetty-server-9.2.2.v20140723.jar.jar"
LOCAL_CLASSPATH="${LOCAL_CLASSPATH}:${JVOICEXML_LIB}/jetty-util-9.2.2.v20140723.jar.jar"
LOCAL_CLASSPATH="${LOCAL_CLASSPATH}:${JVOICEXML_LIB}/servlet-api-3.1.jar.jar"
