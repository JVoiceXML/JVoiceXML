...
public class CancelEvent
    ...
    private static final long serialVersionUID = -7186705973399486496L;
     ...
     * @see #getEventType()
     */
    public CancelEvent(final String message) {
        super(message);
    }
     ...
     * @see #getEventType()
     */
    public CancelEvent(final Throwable cause) {
        super(cause);
    }
     ...
     *        The cause.
     */
    public CancelEvent(final String message, final Throwable cause) {
        super(message, cause);
    }
