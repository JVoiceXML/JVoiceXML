...
standalone server and retrieves the documents from the servlet container or other document repository. 
...
demo implementation, since the speaker and the microphone of the JVoiceXML server
