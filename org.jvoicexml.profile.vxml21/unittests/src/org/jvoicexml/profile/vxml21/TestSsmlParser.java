...
public final class TestSsmlParser {
    ...
    /**
     * Test method for
     * {@link org.jvoicexml.org.jvoicexml.profile.SsmlParser#getDocument()}.
     * 
     * @exception Exception
     *                Test failed.
     ...
     */
    @Test
    public void testGetDocumentFromPlainText() throws Exception, JVoiceXMLEvent {
        final VoiceXmlDocument document = new VoiceXmlDocument();
        final Vxml vxml = document.getVxml();
        vxml.setXmlLang(Locale.US);
        final Form form = vxml.appendChild(Form.class);
        ...
        SsmlParser parser = new VoiceXml21SsmlParser(profile, text, context);
        SsmlDocument ssml = new SsmlDocument();
        Speak speak = ssml.getSpeak();
        speak.setXmlLang(Locale.US);
    ...
    public void testGetDocumentValue() throws Exception, JVoiceXMLEvent {
        ...
        Mockito.when(model.evaluateExpression(testVar + ";", Object.class))
        ...
        final SsmlParsingStrategy valueStrategy = Mockito
                .mock(SsmlParsingStrategy.class);
        SsmlParser parser = new VoiceXml21SsmlParser(profile, prompt, context);
    ...
    public void testGetDocumentDeepClone() throws Exception, JVoiceXMLEvent {
        ...
        Mockito.when(model.readVariable(testVar, Object.class)).thenReturn(
                testValue);
    ...
    public void testDocumentNamespaces() throws Exception, JVoiceXMLEvent {
        final InputStream in = TestSsmlParser.class
                .getResourceAsStream("SsmlParserNSExample.vxml");
