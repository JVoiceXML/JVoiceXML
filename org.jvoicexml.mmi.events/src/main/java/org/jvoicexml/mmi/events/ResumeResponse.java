...
/**
 * An MMI resume response.
 * @author Dirk Schnelle-Walka
 * @since 0.7.6
 */
public final class ResumeResponse extends LifeCycleResponse
    implements Serializable {
    /** The serial version UID. */
    private static final long serialVersionUID = 8914923128779130054L;
     ...
     * @since 0.7.9
     */
    public ResumeResponse(final String requestId, final String source,
