/*
 * File:    $RCSfile: SemanticError.java,v $
 * Version: $Revision$
 * Date:    $Date$
 * Author:  $Author$
 * State:   $State: Exp $
...
public class SemanticError
    ...
    private static final long serialVersionUID = -4390155973917861382L;
     ...
     * @see #getEventType()
     */
    public SemanticError(final Throwable cause) {
        super(cause);
    }
     ...
     *        The cause.
     */
    public SemanticError(final String message, final Throwable cause) {
        super(message, cause);
    }
