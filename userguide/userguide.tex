...
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.jsapi10/src/main/resources/jsapi10-talking-java-implementation.xml}

\section{JSAPI 2.0 with Sphinx and FreeTTS}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.jsapi20/src/main/resources/jsapi20-implementation.xml}

\section{JSAPI 2.0 with Microsoft SAPI}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.jsapi20/src/main/resources/jsapi20-sapi-implementation.xml}

%\section{JTAPI}
%\lstinputlisting[language=XML]{../org.jvoicexml.implementation.jtapi/src/main/resources/jtapi-implementation.xml}

\section{MARC}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.marc/src/main/resources/marc-implementation.xml}

\section{MARY}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.mary/src/main/resources/mary-implementation.xml}

\section{MMI with HTTP ETL}
\lstinputlisting[language=XML]{../org.jvoicexml.callmanager.mmi.http/src/main/resources/mmi-callmanager-http.xml}

\section{MMI with Socket ETL}
\lstinputlisting[language=XML]{../org.jvoicexml.callmanager.mmi.socket/src/main/resources/mmi-callmanager-socket.xml}

\section{MMI with umundo ETL}
\lstinputlisting[language=XML]{../org.jvoicexml.callmanager.mmi.umundo/src/main/resources/mmi-callmanager-umundo.xml}

\section{MRCPv2}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.mrcpv2/src/main/resources/mrcpv2-callmanager.xml}

\lstinputlisting[language=XML]{../org.jvoicexml.implementation.mrcpv2/src/main/resources/mrcpv2-implementation.xml}

\section{Text}
\lstinputlisting[language=XML]{../org.jvoicexml.implementation.text/src/main/resources/text-implementation.xml}
