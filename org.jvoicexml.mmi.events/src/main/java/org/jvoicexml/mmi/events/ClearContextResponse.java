...
public final class ClearContextResponse extends LifeCycleResponse
    ...
    private static final long serialVersionUID = 5204178711326905881L;

    /**
     * Constructs a new object.
     */
    public ClearContextResponse() {
    }
     ...
     * @since 0.7.9
     */
    public ClearContextResponse(final String requestId, final String source,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ClearContextResponse)) {
            return false;
        }
        return true;
    }
