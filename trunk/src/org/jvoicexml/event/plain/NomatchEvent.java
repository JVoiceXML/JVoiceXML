...
public class NomatchEvent
    ...
    private static final long serialVersionUID = 8679616732879896721L;
     ...
     * @see #getEventType()
     */
    public NomatchEvent(final String message) {
        super(message);
    }
     ...
     * @see #getEventType()
     */
    public NomatchEvent(final Throwable cause) {
        super(cause);
    }
     ...
     *        The cause.
     */
    public NomatchEvent(final String message, final Throwable cause) {
        super(message, cause);
    }
