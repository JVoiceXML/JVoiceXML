...
public final class ClearContextRequest extends LifeCycleRequest
    ...
    private static final long serialVersionUID = -4067761985085714840L;

    /**
     * Constructs a new object.
     */
    public ClearContextRequest() {
    }
     ...
     * @since 0.7.9
     */
    public ClearContextRequest(final String requestId, final String source,
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ClearContextRequest)) {
            return false;
        }
        return true;
    }
