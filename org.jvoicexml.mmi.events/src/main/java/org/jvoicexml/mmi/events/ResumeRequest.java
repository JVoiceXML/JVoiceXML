 ...
 * @since 0.7.6
 */
public final class ResumeRequest extends LifeCycleRequest
    implements Serializable {
    /** The serial version UID. */
    private static final long serialVersionUID = -2488386402099818193L;
     ...
     * @since 0.7.9
     */
    public ResumeRequest(final String requestId, final String source,
